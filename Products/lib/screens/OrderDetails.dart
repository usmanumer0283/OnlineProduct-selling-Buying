          ...
          /*padding: EdgeInsets.only(bottom: 100),*/
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Column(
                      ...
                      children:<Widget> [
                        SizedBox(height: 15,),
                        Text('Order No:12111-1111111-11',style: TextStyle(
                          fontFamily: 'Poppins',
                          fontSize: 12,
                          color : TagColor,
                        ),
                          textAlign: TextAlign.left,),
                        Text('Sorted by:ARCHST-shop',style: TextStyle(
                          fontFamily: 'Poppins',
                          fontSize: 12,
                          color : TagColor,
                        ), textAlign: TextAlign.left,),
                ...
                SizedBox(height: 10,),
                Text('Order Screenshot',style: TextStyle(
                  fontFamily: 'Poppins',
                  fontSize: 16,
                  color : TagColor,
                ),),
              ...
              Container(
                ...
                SizedBox(height: 10,),
                Text('Review/Feedback Screenshot',style: TextStyle(
                  fontFamily: 'Poppins',
                  fontSize: 16,
                  color : TagColor,
                ),),
                ...
                SizedBox(height: 10,),
                Text('No review/VVRO Screenshot',style: TextStyle(
                  fontFamily: 'Poppins',
                  fontSize: 16,
                  color : TagColor,
                ),),
                ...
                SizedBox(height: 10,),
                Text('Refund Screenshot',style: TextStyle(
                  fontFamily: 'Poppins',
                  fontSize: 16,
                  color : TagColor,
                ),),
